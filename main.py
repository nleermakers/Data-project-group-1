...
def main():
    limit = 86500# this parameter defines the number of tweets to retrieve before storing them
    pos = None
    iter = 1

    query = "#pauw OR Jeroen Pauw OR #JeroenPauw OR Pauw since:2015-01-10 until:2018-01-19"  # Define here the any query to perform as a string
    ...
    while True:
        ...
        try:
            ...
            if(len(tweets) > 0):
                with open("ids.csv.txt", "a") as id_file:
                    for tweet in tweets:
