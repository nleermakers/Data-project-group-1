...
@generate_ordering('timestamp', 'id', 'text', 'hashtags', 'lang')
 # 'replies', 'retweet_count', 'favorite_count', 'userid', 'hashtags', 'user_mentions', 'lang', 'in_reply_to_user_id', 'in_reply_to_screen_name', 'in_reply_to_status_id', 'urls')
class Tweet:
    def __init__(self, id, timestamp, text, hashtags, lang):
        #self.user = user
        self.id = id
